...
angular.module('starter', ['ionic', 'starter.controllers', 'ngCookies', 'Simos.services'])
...
.run(function($ionicPlatform) {
  ...
  .run(['$rootScope', '$http', '$cookieStore', 'UserInfo',
    function($rootScope, $http, $cookieStore, UserInfo) {

      var userInfo = UserInfo.getUser();
